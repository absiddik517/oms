...
export default {
    ...
    methods: {
        handleDelete(id) {
            if (confirm('Delete this letter type?')) {
                this.loading = true;
                this.deleteingId = id;
                router.delete(route('letter-types.destroy', id), {
                    onSuccess: () => {
                        this.loading = false;
...
<template>
    ...
    <Head title="Letter Types" />
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto p-4">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-2xl font-bold">Letter Types</h1>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-body">
                    ...
                    <tbody>
                        <tr v-for="letterType in letterTypes" :key="letterType.id"
                            ...
                            <td class="text-right">
                                <Link :href="route('letter-types.edit', letterType.id)"
                                ...
                                <Button @click="handleDelete(letterType.id)" :disabled="loading" type="button">
                                    <span v-if="loading && letterType.id === deleteingId">
