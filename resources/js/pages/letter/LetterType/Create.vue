    ...
    data() {
        return {
            ...
            breadcrumbs: [
                ...
                { title: 'Create', href: route('letter-types.create') },
            ],
        };
    },
    methods: {
        submit() {
            ...
            this.form.post(route('letter-types.store'), {
                preserveScroll: true,
                onSuccess: () => {
                    this.loading = false;
                },
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto p-4">
            <h1 class="text-2xl font-bold mb-4">Add Letter Type</h1>
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <Input v-model="form.code" class="mt-2" id="letter_code" placeholder="Letter Code" type="text" />
